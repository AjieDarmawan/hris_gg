...
function absen()
{
   ...
   // echo $url;
    ...
    function check_absen(){
       ...
       // error_reporting(0);
        $id_kar = $this->input->post('id_kar');
          ...
          $karname = $this->db->query("select kar_nik,kar_id,ktr_id from kar_master where kar_id='".$id_kar."'")->row();
    ...
    function cek_alasan(){
        ...
        $tgl = date('Y-m-d');
        $cek = $this->db->query('select abs_alasan_masuk,abs_masuk from abs_master where kar_id = "'.$kar_id.'" and abs_tgl_masuk ="'.$tgl.'"')->row();
     ...
     function cek_absen_hari_ini(){
      ...
      //  $kar_id = $this->input->post('kar_id');
        $tgl = date('Y-m-d');
        $cek = $this->db->query('select d.abs_alasan_masuk,d.abs_masuk,d.abs_pulang,k.kar_nm from abs_master as d join kar_master as k on k.kar_id = d.kar_id where  abs_tgl_masuk ="'.$tgl.'" order by abs_masuk desc ')->result();
