...
{
    $sql = "SELECT * FROM abs_master_dev WHERE kar_id='$kar_id' AND abs_tgl_masuk='$abs_tgl_masuk' ORDER BY abs_id";
...
function absen()
{
   ...
   // echo $url;
    ...
    if ($jarak_skrang <= $jarak_orang2) {
        ...
        $check_absen = $this->db->query("select * from abs_master_dev where kar_id = " . $id_kar . " and date(abs_tgl_masuk) = '" . date('Y-m-d') . "'")->row();
        ...
        if ($check_absen) {
           ...
           // $cek_shift_masuk_ucapan =  $this->cek_shift_masuk();
            ...
            if ($check_absen->abs_tgl_pulang != '0000-00-00') {
                ...
                $this->db->insert('abs_master_dev', $data_absen_simpan);
                ...
                $data_array = array(
                   ...
                   $pho =  $this->save_photo($_FILES['img'],$karname->kar_nik);
                        ...
                        $point = $check_absen->abs_point + $cek_status_pulang['abs_point'];
                            ...
                            $this->db->update('abs_master_dev', $data_absen_simpan,array('abs_id'=>$check_absen->abs_id));
            ...
            if($pho->msg=='success'){
               ...
               // echo "sukses";
                ...
                $this->db->insert('abs_detail_dev', $data_abs_detail);
