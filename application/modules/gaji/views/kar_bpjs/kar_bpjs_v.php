                            ...
                            <tbody>
                                ...
                                ?>
                                	...
                                	<tr>
                                		...
                                		<input type="hidden" value="<?php echo $k->kar_id;?>" name="kar[<?php echo $k->kar_id;?>]">



                                		<td><input  name="bpjs_tk[<?php echo $k->kar_id;?>]" type="checkbox" <?php echo $checked_bpjs_k?> ></td>
                                		<td><input name="bpjs_pk[<?php echo $k->kar_id;?>]" type="checkbox" <?php echo $checked_bpjs_pk?> ></td>


                                	 

                                			<td><input name="jht_tk[<?php echo $k->kar_id;?>]" type="checkbox" <?php echo $checked_jht_k?> ></td>
                                		<td><input name="jht_pk[<?php echo $k->kar_id;?>]" type="checkbox"  <?php echo $checked_jht_pk?>></td>

                                		<td><input name="jp_tk[<?php echo $k->kar_id;?>]" type="checkbox"  <?php echo $checked_jp_k?>></td>
                                		<td><input name="jp_pk[<?php echo $k->kar_id;?>]" type="checkbox"  <?php echo $checked_jp_pk?>></td>

                                		<td><input name="jkk_pk[<?php echo $k->kar_id;?>]" type="checkbox" <?php echo $checked_jkk_pk  ?>></td>
                                		<td><input name="jkm_pk[<?php echo $k->kar_id;?>]" type="checkbox" <?php echo $checked_jkm_pk ?>></td>
                                		<td><input name="status[<?php echo $k->kar_id;?>]" type="checkbox" <?php echo $checked_status ?>></td>
                                	</tr>
