...
<script>
    ...
    $('#tablekaryawan').DataTable({
        ...
        "ajax": {
            ...
            "url": '<?php echo base_url('gaji/komponen_gaji/ajax_list') ?>',
            "type": "POST"
        }
    });
</script>
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".hapus_dokumen", function() {
            ...
            swal({
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>gaji/komponen_gaji/hapus",
                    dataType: "JSON",
                    data: "id=" + id,
        ...
        <div class="modal-content">
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    ...
                    <h4 class="modal-title" id="modalLabel"><i class="fa fa-plus" aria-hidden="true"></i> Form Upload Komponen Gaji</h4>

                </div>
                <div class="modal-body">
                    <form role="form" action="<?php echo base_url('gaji/komponen_gaji/upload_excel') ?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div>
                                <input class="form-control form-control-sm" id="formFileSm" name="file" type="file">
                                Upload Data Komponen Gaji
                                <label>Format Excel</label>
                                <a href="<?php echo base_url('assets/berkas/komponen_gaji.xlsx')?>" class="">Format Excel . xls</a>
                            </div>
                        </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" action="<?php echo base_url('gaji/komponen_gaji/update') ?>" method="post" enctype="multipart/form-data">
                        <div class="row">
