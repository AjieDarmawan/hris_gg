...
<script>
    ...
    $('#tablekaryawan').DataTable({
        ...
        "ajax": {
            ...
            "url": '<?php echo base_url('gaji/listrik/ajax_list') ?>',
            "type": "POST"
        }
    });
</script>
        ...
        <div class="modal-content">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" action="<?php echo base_url('gaji/listrik/upload_excel') ?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div>
                                <div class="">
                                    <label>Bulan</label>
                                ...
                                <a href="<?php echo base_url('assets/berkas/listrik.xlsx')?>" class="">Format Excel . xls</a>
                            </div>
                        </div>
