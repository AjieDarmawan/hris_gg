...
<script>
    ...
    $('#tablekaryawan').DataTable({
        ...
        "ajax": {
            ...
            "url": '<?php echo base_url('gaji/insentif/ajax_list') ?>',
            "type": "POST"
        }
    });
</script>
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".hapus_dokumen", function() {
            ...
            swal({
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>gaji/insentif/hapus",
                    dataType: "JSON",
                    data: "id=" + id,
        ...
        <div class="modal-content">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" action="<?php echo base_url('gaji/insentif/upload_excel') ?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div>
                                <div class="">
                                    <label>Bulan Di dapat</label>
                                ...
                                <div class="">
                                    <label>Bulan Di Bayarkan</label>
                                     <input type="month" name="bulan_dibayarkan" >
                                </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" action="<?php echo base_url('gaji/insentif/update') ?>" method="post" enctype="multipart/form-data">
                        <div class="row">
