<div class="container pt-5">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#upload_excel_pinjam">Upload Excel Pinjam</button>
            <a href="<?php echo base_url('gaji/paguyuban/data_list')?>" class="btn btn-primary btn-sm" >Data Paguyuban</a>
            <br>
            <div mb-2>
        ...
        <div class="modal-content">
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    ...
                    <h4 class="modal-title" id="modalLabel"><i class="fa fa-plus" aria-hidden="true"></i> Form Upload Paguyuban</h4>

                </div>
                <div class="modal-body">
                    <form role="form" action="<?php echo base_url('gaji/paguyuban/upload_excel') ?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div>
                                <div class="">
                                    <label>Bulan</label>
                                ...
                                <a href="<?php echo base_url('assets/berkas/paguyuban.xlsx')?>" class="">Format Excel . xls</a>
                            </div>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    ...
                    <h4 class="modal-title" id="modalLabel"><i class="fa fa-plus" aria-hidden="true"></i> Form Upload Pinjam Nama Paguyuban</h4>

                </div>
                <div class="modal-body">
                    <form role="form" action="<?php echo base_url('gaji/paguyuban/upload_excel_paguyuban_pinjam') ?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div>
                                <div class="">
                                    <label>Bulan</label>
