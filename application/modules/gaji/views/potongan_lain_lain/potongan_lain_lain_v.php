<div class="container pt-5">
    ...
    <div class="row">
        <div class="col-md-12">
            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#upload_excel">Tambah </button>
            <br>
            <div mb-2>
...
<script>
    ...
    $('#tablekaryawan').DataTable({
        ...
        "ajax": {
            ...
            "url": '<?php echo base_url('gaji/potongan_lainnya/ajax_list') ?>',
            "type": "POST"
        }
    });
</script>
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".hapus_dokumen", function() {
            ...
            swal({
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>gaji/potongan_lainnya/hapus",
                    dataType: "JSON",
                    data: "id=" + id,
        ...
        <div class="modal-content">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    ...
                    <h4 class="modal-title" id="modalLabel"><i class="fa fa-plus" aria-hidden="true"></i> Form Tambah Potongan Lainya</h4>

                </div>
                <div class="modal-body">
                    <form role="form" action="<?php echo base_url('gaji/potongan_lainnya/simpan') ?>" method="post" enctype="multipart/form-data">
                        <div class="">
                            <div>
                                ...
                                <div class="form-group">
                                    <label>Bulan</label>
                                    <input required class="form-control"  type="month" name="bulan">
                                </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" action="<?php echo base_url('gaji/potongan_lainnya/update') ?>" method="post" enctype="multipart/form-data">
                        <div class="row">
