...
class Final_gaji extends CI_Controller
{
        ...
        //   die;
          ...
          foreach($rowData as $key => $k){
            ...
            if($k[0][1]!='nik' and $k[0][1]!='NIK' and $k[0][1]!=''){
                ...
                $cek_update = $this->db->query("select * from payroll.final_gaji_testing where kar_nik='".$nik."' and bulan = '".$bulan."' ")->row();
    ...
    function selisih_final_gaji(){
        ...
        join payroll.final_gaji_testing as t on t.kar_id = f.kar_id
        where f.bulan="09-2022" and t.bulan="09-2022" '
