...
class Potongan_lainnya_M extends CI_Model
{


    //set nama tabel yang akan kita tampilkan datanya
    var $table = 'payroll.potongan_lain_lain';
    //set kolom order, kolom pertama saya null untuk kolom edit dan hapus
    var $column_order = array('bulan','nik',null,null,null,null);

    var $column_search = array('bulan','nik');
    // default order 
    var $order = array('id_potongan_lain_lain' => 'desc');
    ...
    {   
        ...
        $this->db->join('kar_master', 'kar_master.kar_id = payroll.potongan_lain_lain.kar_id', 'inner');
