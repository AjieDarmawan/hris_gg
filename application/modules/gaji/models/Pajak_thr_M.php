...
class Pajak_thr_M extends CI_Model
{


    //set nama tabel yang akan kita tampilkan datanya
    var $table = 'payroll.pajak_thr';
    ...
    // default order 
    var $order = array('id_pajak_thr' => 'desc');
    ...
    {   
        ...
        $this->db->join('kar_master', 'kar_master.kar_id = payroll.pajak_thr.kar_id', 'inner');
