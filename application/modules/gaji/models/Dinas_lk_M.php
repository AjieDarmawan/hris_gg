...
class Dinas_lk_M extends CI_Model
{
    ...
    // default order 
    var $order = array('id_dinas_lk' => 'desc');
    ...
    {   
        ...
        $this->db->join('kar_master', 'kar_master.kar_id = dinas_lk.kar_id', 'inner');
        $this->db->from($this->table);
        $this->db->where('month(tgl_selesai)',$bulan_where);
