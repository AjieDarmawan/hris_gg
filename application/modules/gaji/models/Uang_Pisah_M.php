...
class Uang_Pisah_M extends CI_Model
{


    //set nama tabel yang akan kita tampilkan datanya
    var $table = 'payroll.uang_pisah';
    //set kolom order, kolom pertama saya null untuk kolom edit dan hapus
    var $column_order = array('bulan','kar_nik','kar_dtl_sts_nkh',null,null);

    var $column_search = array('bulan','kar_nik');
    // default order 
    ...
    {   
        ...
        $this->db->join('kar_master', 'kar_master.kar_id = payroll.uang_pisah.kar_id', 'inner');
