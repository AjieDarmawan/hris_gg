    ...
    <div class="brand flex-column-auto" id="kt_brand">
        ...
        <button class="brand-toggle btn btn-sm px-0" id="kt_aside_toggle">
            <span class="svg-icon svg-icon svg-icon-xl">
                <!--begin::Svg Icon | path:assets/template/assets/media/svg/icons/Navigation/Angle-double-left.svg-->
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                <?php 
                        ...
                        // print_r($sess);
                        // die;
                                if($sess['pegawai']['kar_id']!='447'){
                            ?>
                <li class="menu-item menu-item-active" aria-haspopup="true">
                    <a href="<?php echo base_url('pegawai')?>" class="menu-link">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="<?php echo base_url('master/karyawan')?>" class="menu-link">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="<?php echo base_url('master/divisi')?>" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="<?php echo base_url('master/jabatan')?>" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="<?php echo base_url('master/level')?>" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="<?php echo base_url('master/unit')?>" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="<?php echo base_url('master/kantor')?>" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <!-- <li class="menu-item" aria-haspopup="true">
                                            <a href="<?php echo base_url('gaji/Kar_sembako')?>" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">Karyawan Sembako </span>
                                            </a>
                                        </li> -->
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                         ...
                                         <li class="menu-item" aria-haspopup="true">
                                            <a href="<?php echo base_url('gaji/Kar_Bpjs')?>" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">Karyawan Bpjs </span>
                                            </a>
                                        </li>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                         ...
                                         <!--  <li class="menu-item" aria-haspopup="true">
                                            <a href="<?php echo base_url('gaji/pajak_thr')?>" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">Itungan THR Potongan Pajak</span>
                                            </a>
                                        </li> -->


                                          <!--  <li class="menu-item" aria-haspopup="true">
                                            <a href="<?php echo base_url('gaji/pajak_thr_nominal')?>" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">Pajak THR</span>
                                            </a>
                                        </li> -->
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="<?php echo base_url('gaji/uang_pisah')?>" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">Uang Pisah </span>
                                            </a>
                                        </li>


                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="<?php echo base_url('gaji/potongan_lainnya')?>" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">Potongan Lainya </span>
                                            </a>
                                        </li>
